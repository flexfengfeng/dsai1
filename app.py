...
# def telegram():
#     domain_url = 'https://dsai1.onrender.com'
...
#         # set status message
#         status = "The telegram bot is running. Please check with the telegram bot. @dsai_ft1_ff_bot."
#     else:
...
#     if webhook_response.status_code == 200:
#         # set status message
#         status = "The telegram bot is stopped. Please check with the telegram bot. @dsai_ft1_ff_bot."
#     else:
